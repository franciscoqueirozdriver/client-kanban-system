...
export const SNAPSHOT_HEADERS = [
  'Cliente_ID','Empresa_ID','Nome da Empresa','CNPJ','Qtd_Total','Qtd_DCOMP','Qtd_REST','Qtd_RESSARC','Risco_Nivel','Risco_Tags_JSON','Por_Natureza_JSON','Por_Credito_JSON','Datas_JSON','Primeira_Data_ISO','Ultima_Data_ISO','Resumo_Ultima_Consulta_JSON_P1','Resumo_Ultima_Consulta_JSON_P2','Card_Schema_Version','Rendered_At_ISO','Fonte','Data_Consulta','URL_Comprovante_HTML','Payload_Bytes','Last_Updated_ISO','Snapshot_Hash','Facts_Count','Consulta_ID','Erro_Ultima_Consulta',
];
...
export async function upsertPerdecompSnapshot(row: any[]) {
  ...
  if (rowIndex) {
    const range = `perdecomp_snapshot!A${rowIndex}`;

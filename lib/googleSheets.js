...
// ✅ Insere linha no histórico, aplicando canal padrão para mudanças de fase
export async function appendHistoryRow(data) {
  if (data?.tipo === 'Mudança de Fase' && !data.canal) {
    // Se não foi informado canal em mudança de fase, usar "Sistema"
    data.canal = 'Sistema';
  }

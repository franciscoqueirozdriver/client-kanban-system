...
export async function updateRow(rowNumber, data) {
    ...
    for (const key in data) {
        // Convert keys like `status_kanban` or `Cor_Card` to match the
        // spreadsheet header format (e.g., "Status Kanban", "Cor Card").

...
const valuesAppendMock = jest.fn().mockResolvedValue({});
const valuesUpdateMock = jest.fn().mockResolvedValue({});
const spreadsheetsBatchUpdateMock = jest.fn().mockResolvedValue({});

...
import { FaChartBar, FaUsers, FaColumns, FaCog, FaHome, FaFileAlt } from 'react-icons/fa';
...
export default function Sidebar() {
  ...
  const links = [
    ...
    { href: '/consultas/perdecomp-comparativo', label: 'PER/DCOMP (Comparativo)', icon: <FaFileAlt /> },
